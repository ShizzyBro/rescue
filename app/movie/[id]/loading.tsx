    ...
    <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="text-center space-y-2">
          <h3 className="text-2xl font-bold text-white">Loading Content</h3>
          <p className="text-sm text-white/60">Preparing your experience...</p>
        </div>
        ...
        {/* Rotating film strip indicator */}
        <div className="flex gap-1">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="w-2 h-6 bg-red-500/30 rounded-sm animate-pulse"
              style={{
